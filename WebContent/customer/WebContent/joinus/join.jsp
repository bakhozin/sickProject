						...
						<div id="join-form" class="join-form margin-large">
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="mid" /><span> 4~12자리 영문자(단 영어로
										시작)</span>
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="radio" name="gender" id="male" value="남자" checked />남자 <input
										type="radio" name="gender" id="female" value="여자" />여자
								</dd>
							</dl>
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="phone" /><span> 대시(-)를 포함할 것:
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data habit">
									<input type="checkbox" name="habit" id="music" value="음악"/><label
										for="music">음악</label> <input type="checkbox" name="habit"
										id="movie" value="영화"/><label for="movie">영화</label> <input
										type="checkbox" name="habit" id="trip" value="여행"/><label for="trip">여행</label>
								</dd>
							</dl>
						</div>
